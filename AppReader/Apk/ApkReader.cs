...
namespace Hausthy.AppReader
{
    public class ApkReader
    {
        ...
        public ApkInfo ZipApk(string apkPath)
        {
            ...
            return extractInfo(manifestData, resourcesData);
        }
        ...
        private ApkInfo extractInfo(byte[] manifest_xml, byte[] resources_arsx)
        {
        ...
        private ApkInfo extractInfo(XmlDocument manifestXml, byte[] resources_arsx)
        {
